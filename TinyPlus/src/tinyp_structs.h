...
void token_pair_print(token_pair_t* ptoken_pair);
void token_pair_kind_key(token_pair_t* ptoken_pair);
void token_pair_copy(token_pair_t* dest, const token_pair_t* src);
